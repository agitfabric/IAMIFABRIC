CREATE PROCEDURE [dbo].[SP_REPORT_58_MODIFIED]
...
BEGIN
	...
	DELETE from Report_58 where WONumber in (SELECT WONumber from SILVER_WAREHOUSE.dbo.ZReportServiceSA)
	...
	FROM SILVER_WAREHOUSE.dbo.ZReportServiceSA a
