...
BEGIN
    ...
    SELECT @GetMaxRunningDate = ISNULL(CAST(MAX(RunningDate)+'01' AS date), '2019-09-01'),
           @GetCurrentDate    = CAST(DATEADD(HOUR,7,GETDATE()) AS date)
    FROM Report_44_UnitServed_ServiceShare;
    ...
    BEGIN
        ...
        WHERE RunningDate COLLATE Latin1_General_CI_AS = @LoopYearMonth COLLATE Latin1_General_CI_AS;
        ...
        FROM (
            ...
            SELECT
                ...
                CASE
                    WHEN InventSiteId COLLATE Latin1_General_CI_AS IN ('ASC01','ASC03') 
                         AND LEFT(@LoopYearMonth, 4) >= '2022' THEN 'ASC02'
                    WHEN InventSiteId COLLATE Latin1_General_CI_AS = 'AUT02' 
                         AND LEFT(@LoopYearMonth, 4) >= '2022' THEN 'AUT01'
                    ELSE InventSiteId
        ...
        DELETE FROM #TempYearMonth 
        WHERE YearMonth = @LoopYearMonth;
    END
