CREATE    PROCEDURE SP_REPORT_25noADO AS
...
FROM GOLD_WAREHOUSE.dbo.Report_25noADO;
...
-- Final output
INSERT INTO GOLD_WAREHOUSE.dbo.Report_25noADO
SELECT 
    DatePhysical,
    Area,
    Nama_Dealer,
...
where DatePhysical between '2025-01-01' and '2025-05-31'