...
CREATE VIEW [dbo].[vw_DeviceModel_PSS] AS (SELECT DISTINCT d.ModelId AS ItemID, d.Name AS Item_Name, it.AMItemMajorGroupId AS MajorGroup, it.AMItemMinorGroupId AS MinorGroup, it.ZSeriesType AS Tipe_Series, d.ClassId AS Segment_Desc
